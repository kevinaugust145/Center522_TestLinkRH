...
-(void)reachabilityChanged:(NSNotification*)note
{
    ...
    {
        [InterfaceUtility displayAlertViewWithTitle:@"UTILITY" andMessage:@"UTILITY Internet available"];
    }
    else
    {
        [InterfaceUtility displayAlertViewWithTitle:@"UTILITY" andMessage:@"UTILITY Internet Not available"];
    }
